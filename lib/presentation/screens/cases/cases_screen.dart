...
class CaseCard extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) {
    return Card(margin: const EdgeInsets.only(bottom: 12), child: InkWell(onTap: () => context.go('/cases/${caseItem.id}'), borderRadius: BorderRadius.circular(8), child: Padding(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
...
class CaseDocsDialog extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) {
    ...
    return Dialog(insetPadding: const EdgeInsets.all(16), child: Container(constraints: const BoxConstraints(maxWidth: 600, maxHeight: 500), child: Column(mainAxisSize: MainAxisSize.min, children: [
      Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: AppColors.primaryNavy, borderRadius: const BorderRadius.vertical(top: Radius.circular(8))), child: Row(children: [Icon(Icons.attach_file, color: AppColors.textOnLight, size: 24), const SizedBox(width: 8), Text('مستندات الدعوى: ${caseItem.caseNumber}', style: AppTextStyles.headline6.copyWith(color: AppColors.textOnLight))])),
