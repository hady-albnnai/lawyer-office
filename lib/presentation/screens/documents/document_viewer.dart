...
void openDocument(BuildContext context, String documentId) => Navigator.of(context).push(MaterialPageRoute(builder: (c) => DocumentViewerScreen(documentId: documentId)));
